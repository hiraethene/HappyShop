...
class CustomerModelTest {
    ...
    void testMakeOrganizedTrolleyMerging() {
    ...
    void testMakeOrganizedTrolleySorting() {
        CustomerModel cm = new CustomerModel();
        Product product1 = new Product("0001", "TV", "0001.jpg", 269.00, 100);
...
//    void testHandleStockShortages() throws IOException, SQLException {
//        CustomerModel cm = new CustomerModel();
//        customer.databaseRW = new DatabaseRW() {
//
//        }
//
//    }
